    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_questionForUsers", x => x.IdQues);
                    table.ForeignKey(
                        name: "FK_questionForUsers_questions_QuestionId",
                        column: x => x.QuestionId,
                        principalTable: "questions",
                        principalColumn: "QuestionId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_questionForUsers_user_UserId",
                        column: x => x.UserId,
                        principalTable: "user",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_questionForUsers_QuestionId",
                table: "questionForUsers",
                column: "QuestionId");

            migrationBuilder.CreateIndex(
                name: "IX_questionForUsers_UserId",
                table: "questionForUsers",
                column: "UserId");
